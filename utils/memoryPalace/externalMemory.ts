...
3. 只允许做三件事：按事件自然分段、整理时间顺序、把叙述者代词机械地换成 ${charName} 的第一人称“我”（用户称为“${userLabel}”）。除必要的代词替换外，尽量保留原句措辞；引号内对话严禁改写。
...
6. room 按内容放到对应房间：
   - living_room：纯日常琐事
   - bedroom：${userLabel}和我的亲密情感、深层羁绊
   - study：工作、学习、技能、职业
   - user_room：${userLabel}的个人信息、经历、家人、朋友、同事与人际事件
