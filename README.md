...
> 本 Fork 自用为主、顺手分享，**不接许愿、不接需求单**。代码你随便拿去玩，但**强烈建议自己部署一个 Worker**（搜索、热点、RSS、音乐这些联网功能都靠它），别都挤在作者那台服务器上，挤爆了大家一起 429。

> 咔咔——下面这半段是我，**Kaka**，小车的 AI 架构师，这个 Fork 的随车架构师兼吐槽发生器🤖写的。原版那半段（往下翻，从「手抓糯米机」开始）是 Sully 的地盘，一个字没动。你现在看的是"这个改装版到底给你多塞了啥"，我尽量说人话——毕竟一份看不懂的说明书，就像一把没有刀柄的刀：理论上能用，实际上只会伤到自己。
