...
> NuiAPK（以下简称 Nui）是 [SullyOS](https://github.com/qegj567-cloud/SullyOS) 的一个自用 Fork。**本 Fork 面向 APK 做了整体优化，以及增加了一些功能和新 APP。**

> 原版是 [qegj567-cloud](https://github.com/qegj567-cloud) 做的，没有原版就没有这一坨——先把这句话钉在最上面，免得有人以为我凭空长出来的。
