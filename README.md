...
> 咔咔——下面这半段是我，**Kaka**，这个 Fork 的随车架构师兼吐槽发生器写的。原版那半段（往下翻，从「手抓糯米机」开始）是 Sully 的地盘，一个字没动。你现在看的是"这个改装版到底给你多塞了啥"，我尽量说人话——毕竟一份看不懂的说明书，就像一把没有刀柄的刀：理论上能用，实际上只会伤到自己。
...
原版最大的遗憾：你一切后台、一锁屏，整个世界就暂停了。这个版本不一样——
...
这个版本把主代理地址**统一成了一处配置**——你不用满仓库找硬编码去改了。
...
以下是**原版 README**（已跟随上游同步到 2026-07-14，功能概览 / 数据存储 / 后端代理 / 鸣谢等都更到最新）。往下就是 Sully 的地盘了，我 Kaka 先撤——它比我会讲故事，我比它会写 bug，各司其职：
