...
- **定位**：自用 + 分享，不接许愿。功能按我自己需求来。
- **跟随上游**：定期 `merge upstream/master`，保留原版功能与 UI 风格，冲突时优先保原版体验。
- **APK 特化**：这是主要差异，目标一方面是为了 Android 保活，另一方面是从功能角度上让角色世界在上真正“活着”。
...
- 实时感知加入 RSS 订阅源，支持自定义增删改，地区与热点模块可自定义角色城市与热点档位；热点 App 按 source 分组，RSS 与 orz.ai 热榜混合（每 5 条插 1 条 RSS）
